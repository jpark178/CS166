...
;
   ...
   public static void topKHighestRoomPriceForADateRange(DBProject esql){
	  ...
	  String query;
	  try {
		  query = "SELECT * FROM Room R, Booking B WHERE R.hotelID = B.hotelID AND B.bookingDate >= \'" + startingDate + "\' AND B.bookingDate <= \'" + endingDate + "\' ORDER BY B.price DESC LIMIT " + k + ";";
		  esql.executeQuery(query);
	  } catch (Exception e) {
		  System.out.println("Query failed. " + e.getMessage());
	  }
